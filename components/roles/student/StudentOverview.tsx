...
export default function StudentOverview({ user }: StudentOverviewProps) {
  ...
  const quickLaunchers = [
    {
      title: 'AI Voice Call Practice',
      icon: PhoneCall,
      desc: 'Real-time phone & browser call practice with JETHAT AI tutor',
      tab: 'ai-calls',
      badge: 'LIVE VOICE',
      accent: 'text-[#0B3D91]',
      bgAccent: 'bg-[#EEF3F8]',
    ...
    {
      title: 'Sambhasini AI Suite',
      icon: Sparkles,
      desc: 'ASR cadence, Neural TTS & ULCA Script Studio engines',
      tab: 'Sambhasini-ai',
      badge: 'SOVEREIGN AI',
      accent: 'text-[#FF9933]',
    ...
    },
    {
      ...
      icon: BookOpen,
      desc: 'Step-by-step Devanagari & conversational grammar modules',
      tab: 'lesson',
      badge: 'CEFR A1-B2',
      accent: 'text-[#138808]',
  ...
  const executiveStats = [
    {
      label: 'ACTIVE TRACK',
      value: 'Diplomatic & Treaties',
      sub: 'CEFR B1 Target • Track A',
      icon: Shield,
      accent: 'text-[#0B3D91]',
      bg: 'bg-[#EEF3F8]',
    },
    {
      ...
      value: 'Level 4: Intermediate',
      sub: '68% of 12 Units Complete',
      icon: GraduationCap,
      accent: 'text-[#FF9933]',
      bg: 'bg-amber-50',
      progress: 68,
    },
    {
      ...
      value: '94.2% ULCA Cadence',
      sub: 'Phonetic Alignment Verified',
      icon: Volume2,
      accent: 'text-[#138808]',
      bg: 'bg-emerald-50',
    },
    {
      ...
      value: '2 Diplomas Issued',
      sub: '48.5 hrs Total Practice Logged',
      icon: Award,
      accent: 'text-[#0B3D91]',
      bg: 'bg-[#EEF3F8]',
    },
            ...
            <div className="space-y-1.5 text-left">
              <div className="flex flex-wrap items-center gap-2">
                ...
                <span className="text-slate-300 text-xs font-semibold">
                  MEA Language Scholar Console
                </span>
              </div>
              <h2 className="text-xl sm:text-2xl font-black text-white leading-tight">
                Welcome back, {user?.name || 'Aarav Sharma'}! <br />
                <span className="text-[#FF9933]">
                  Ready to master your next Devanagari lesson?
                </span>
              </h2>
              <p className="text-xs text-slate-200 font-medium">
                You are on track to unlock your next CEFR Accredited Sovereign Language Diploma.
              </p>
            </div>
          </div>

          <Link
            href="/dashboard/student?tab=diagnostic"
            className="relative z-10 px-5 py-2.5 rounded-sm bg-[#FF9933] hover:bg-[#E68A00] text-[#051C45] font-extrabold text-xs uppercase tracking-wider flex items-center gap-2 shrink-0 transition shadow-sm"
          >
            PLACEMENT DIAGNOSTIC <ArrowRight className="w-4 h-4 text-[#051C45]" />
          </Link>
        </div>
        ...
        <div className="lg:col-span-4 p-5 rounded-sm bg-white border border-[#DCE2E6] flex flex-col justify-between space-y-3.5 shadow-2xs text-left">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <h4 className="text-xs font-extrabold text-[#1B2A4A]">Sambhasini AI Shikshak (AI Tutor)</h4>
                <span className="text-[10px] text-[#138808] font-bold flex items-center gap-1.5">
                  <span className="w-2 h-2 rounded-full bg-[#138808] animate-ping" /> Online 24/7 Sovereign Model
                </span>
              </div>
            </div>
          ...
          <div>
            <p className="text-xs text-[#555555] italic font-medium leading-relaxed bg-[#F8FAFC] p-3 rounded-sm border-l-2 border-[#FF9933]">
              &quot;Namaste! Ready for a 5-minute Diplomatic Courtesy and Spoken Speech practice today?&quot;
            </p>
          </div>

          <Link
            href="/dashboard/student?tab=Sambhasini-ai"
            className="w-full py-2 rounded-sm bg-[#0B3D91] hover:bg-[#082C6C] text-white font-extrabold text-xs uppercase tracking-wider text-center block transition shadow-2xs"
          >
            Launch Sambhasini AI Suite →
          </Link>
        </div>
      </div>
